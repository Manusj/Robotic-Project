...
import record_semantic_executor
import randomWalk_executor
...
class tst_executor:
    ...
    def __init__(self):
        ...
        self.tst_executor_registry.registerNodeExecutor(
              self.tst_registry.model("record-semantic"), record_semantic_executor.RecordSemanticsExecutor)

        self.tst_executor_registry.registerNodeExecutor(
              self.tst_registry.model("random-walk"), randomWalk_executor.RandomWalkExecutor)
