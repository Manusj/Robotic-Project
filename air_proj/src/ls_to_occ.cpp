...
public:
  ...
  ros::ServiceServer m_mapResetRequest;
  ...
  bool mapReset(std_srvs::Empty::Request& request, std_srvs::Empty::Response& response){
    /*delete m_occ;
  ...
  m_cell_size(0.1), m_robot_size(1.0)
  {
    ...
    m_mapResetRequest = m_nodeHandle.advertiseService("map_reset", &LStoOCC::mapReset, this);
