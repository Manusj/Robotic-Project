...
public:
   ...
   */
  OCC(double _cell_size, double _initial_radius) : m_map(nullptr), m_cell_size(_cell_size), m_initial_radius(_initial_radius), m_initial_radius_cpy(_initial_radius)
  {
  ...
  void resetMap()
  {
    m_initial_radius = m_initial_radius_cpy;
